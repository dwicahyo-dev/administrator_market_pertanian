...
return [
    ...
    */
    ...
    'image'                => 'Isian Gambar :attribute harus berupa gambar.',
    ...
    */
    ...
    'custom' => [
        ...
        'quality_name' => [
            'required' => 'Bidang isian nama kualitas wajib diisi.',
            'unique' => 'Isian nama kualitas sudah ada sebelumnya.',
        ],
        'quality_id' => [
            'required' => 'Bidang isian kualitas wajib diisi.',
        ],
        'commodity_name' => [
        ...
        'agriculture_name' => [
            ...
            'unique' => 'Isian nama hasil pertanian sudah ada sebelumnya.',
        ],
        'agriculture_id' => [
        ...
        'email' => [
            'required' => 'Bidang isian :attribute nama wajib diisi.',
        ],
        'quality_name' => [
            'required' => 'Bidang isian nama kualitas wajib diisi.',
            'unique' => 'Isian nama kualitas sudah ada sebelumnya.',
        ...
        'lowest_price' => [
            'required' => 'Bidang isian harga terendah wajib diisi.',
            'lt' => 'Isian harga terendah harus kurang dari harga tertinggi.',
        ],
        'highest_price' => [
            'required' => 'Bidang isian harga tertinggi wajib diisi.',
            'gt' => 'Isian harga tertinggi harus lebih besar dari harga terendah.',
        ],
        'name' => [
            'required' => 'Bidang isian nama user wajib diisi.',
        ],
        'email' => [
            'required' => 'Bidang isian email user wajib diisi.',
            'unique' => 'Bidang isian email user sudah ada sebelumnya.',
        ],
    ],
